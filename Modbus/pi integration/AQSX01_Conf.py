...
def setGreenAmberThreshold(instrument: minimalmodbus.Instrument, valueToWrite: int) -> None:     
...
def setAmberRedThreshold(instrument: minimalmodbus.Instrument, valueToWrite : int) -> None:        
...
def setTemperatureOffset(instrument: minimalmodbus.Instrument, valueToWrite : int) -> None:      
...
def setEsp8266ResetPeriod(instrument: minimalmodbus.Instrument, valueToWrite : int) -> None:       
