...
def setGreenAmberThreshold(instrument, valueToWrite):     
...
def setAmberRedThreshold(instrument, valueToWrite):     
...
def setSlaveAddress(instrument, valueToWrite):     
...
def setTemperatureOffset(instrument, valueToWrite):     
...
def setEsp8266ResetPeriod(instrument, valueToWrite):     
